import React from 'react';
    ...
    const testimonialsData = [
      { id: 1, alt: 'Depoimento de membro 1', src: testimonial1 },
      { id: 2, alt: 'Depoimento de membro 2', src: testimonial2 },
      { id: 3, alt: 'Depoimento de membro 3', src: testimonial3 },
      { id: 4, alt: 'Depoimento de membro 4', src: testimonial4 },
      { id: 5, alt: 'Depoimento de membro 5', src: testimonial5 },
      { id: 6, alt: 'Depoimento de membro 6', src: testimonial6 },
    ];
    ...
    const TestimonialsSection = () => {
      ...
      return (
        <section id="membros" className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-between items-center mb-10 md:mb-12">
              <AnimatedTitle 
                text="O que os membros dizem" 
                el="h2"
                className="text-3xl md:text-4xl font-bold text-foreground text-center sm:text-left mb-4 sm:mb-0"
                delay={0}
                stagger={0.02}
              />
              <motion.div
              ...
              >
                 <Button
                    size="lg"
                    className="bg-white text-black hover:bg-gray-100 border border-transparent text-base font-bold py-3 px-8 rounded-full shadow-[0_0_20px_rgba(255,255,255,0.6)] hover:shadow-[0_0_30px_rgba(255,255,255,0.8)] relative overflow-hidden group transform transition-all duration-300"
                    asChild
                  >
                    <motion.a
                      href={hotmartLink}
              ...
              >
                {duplicatedTestimonials.map((testimonial, index) => (
                  <div
                    ...
                    className="flex-shrink-0 bg-card rounded-lg shadow-lg overflow-hidden mx-3" 
                    style={{ 
